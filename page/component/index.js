...
Page({
  data: {
    top: 0,
    hot: [
      { name: '10.6.1.1', url: '/page/component/scroll-view/scroll-view' },
      { name: '10.6.1.2', url: '/page/component/map/map' },
      { name: '10.6.1.3', url: '/page/component/icon/icon' },
      { name: '10.6.1.4', url: '/page/component/card/card' },
      { name: '10.6.1.5', url: '/page/API/get-auth-code/get-auth-code' },
      { name: '10.6.1.6', url: '/page/component/popup/popup' },
      { name: '10.6.1.7', url: '/page/API/request/request' },
      { name: '10.6.1.8', url: '/page/component/canvas/canvas' },
      { name: '10.6.1.9', url: '/page/API/navigator/navigator' },
    ],
    tabs: ['基础组件', '扩展组件'],
    activeTab: 0, 
    basicComponentList,
